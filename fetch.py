#!/usr/bin/env python3
"""
Recuperation des codes promo Booking.com depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/booking.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/booking.com"
STORE_NAME = "Booking.com"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Booking.com depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-booking)"
    }
    try:
